...
var AccountsPayments, CancelSubscription, Confirm, Days, EatLater, EatNow, EatNowRestaurant, FullMenuRestaurant, GraphRestLater, GraphTimeLater, Home, LunchDate, ManageSubscriptions, RestaurantSubscriptionActive, SearchRestLater, SelectTimeLater, Subscribe, app;
...
SearchRestLater = function($scope, $rootScope) {
  $scope.search = "";
  $scope.favorites = [
    {
      name: "Boloco",
...
EatNow = function($scope, $rootScope, $http, $timeout) {
  ...
  $scope.updateNearbys = function(nearbys) {
    return $scope.mapSrc = "https://maps.googleapis.com/maps/api/staticmap?center=71 Mount Auburn Street, Cambridge, MA&zoom=15&size=288x200&markers=71 Mount Auburn Street, Cambridge, MA||24 Holyoke Street, Cambridge, MA|14 John F. Kennedy Street, Cambridge MA|1312 Massachusetts Avenue&sensor=false";
  };
  $scope.mapSrc = "";
...
EatLater = function($scope, $http, $rootScope) {
  ...
  plot = function(data) {
    ...
    return plotGraph = $.plot($(css_id), data, options);
  };
  $scope.init();
